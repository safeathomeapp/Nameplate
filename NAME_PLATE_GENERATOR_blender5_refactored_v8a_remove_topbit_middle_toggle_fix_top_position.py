...
def drawPlateTrue(self, context):
    ...
    # Blender cube location is its centre, so to sit the TopBit on top of the
    # main plate we need to offset by half of the TopBit height above user_z.
    top_position = user_z + (top_height * 0.5)
                ...
                if obj and obj.name == 'PLATE':
                    if import_plate:
                        ...
                        if mytool.top_options:
                            ...
                            box.label(text="Top plate position fixed on top")
