...
def _mirror_nurnie(side):
    ...
    source_y = source_anchor_obj.location.y
    source_z = source_anchor_obj.location.z
    source_x = source_anchor_obj.location.x
    mirrored_x = -source_x
    ...
    if base_type == "S":
        plane_location = (mirrored_x, -base_size_y * 0.5 - 0.5, 2)
    else:
        plane_location = (mirrored_x, -1.5, source_z)
    ...
    target_anchor_obj.location[0] = mirrored_x
    target_anchor_obj.location[1] = source_y
    target_anchor_obj.location[2] = source_z
